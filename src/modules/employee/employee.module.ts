...
@Module({
    imports: [SalariesModule, KpiModule, SubmissionModule, TeachersModule, PresenceEmployeeModule, PresenceTeacherModule, PresenceEmployeeModule, AdministrationEmployeeModule, SubmissionModule, SalariesModule, KpiModule],
})
